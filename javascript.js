/* eslint-env node */
const hamBug = document.querySelector('.hambur');
...
hamBug.addEventListener('clicked', () => {
...
const $worksSection = document.getElementById('potfolio');
  ...
  if (i === 0) {
    ...
    card.innerHTML = `<div class="row">
        ...
        <div class="page2-2 col-6">
          ...
          <div class="page2-6">
            <a href="#">${ProjectList[i].tecnologies.fistTec}</a>
            <a href="#">${ProjectList[i].tecnologies.seondTec} </a>
            <a href="#">${ProjectList[i].tecnologies.thidTec} </a>
          </div>
          <div class="page2-7">
            <button data-modal-target=".modal" class="openModalTarget">${Projecist[i].button}</button>
          </div>
        </div>
      </div>`;
